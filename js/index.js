document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- 2. Professional Deep Starry Night Background ---
  const initStarfield = () => {
    ...
    const numStars = isDesktop ? 250 : 80;
  ...
  const initGsapAnimations = () => {
    ...
    gsap.utils.toArray(".catalog-grid, .ledger-list").forEach(container => {
